...
This is a very simple application, with the following features.

- User gets a random coffee image (from https://coffee.alexflipnote.dev/)
- Then can request a new random coffee image
- Also can mark a coffe image as favorite, and then access anytime, even without internet connection.
